...
class Linear(tf.keras.layers.Layer):
    def __init__(self,
        ...
        self._field_embedding(tf.constant([0], dtype=tf.int32))
...
class Embedding(tf.keras.layers.Layer):
    def __init__(
        ...
        # Force initialization
        self._embedding(tf.constant([0], dtype=tf.int32))
        self.built = True
...
class MatrixFactorizationLayer(tf.keras.layers.Layer):
    def __init__(
        ...
        self.user_mf_embedding(tf.constant([0], dtype=tf.int32))
        self.item_mf_embedding(tf.constant([0], dtype=tf.int32))
        self.u_bias(tf.constant([0], dtype=tf.int32))
        self.i_bias(tf.constant([0], dtype=tf.int32))
